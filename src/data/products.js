...
export const PRODUCTS = [
  ...
  { name: 'Roller Blinds', cat: 'Blinds', img: p('roller-blinds') },
  { name: 'Blackout Roller Blinds', cat: 'Blinds', img: p('blackout-roller-blinds') },
  { name: 'Aluminium Venetian Blinds', cat: 'Blinds', img: p('aluminium-venetian-blinds') },
  { name: 'Wooden Venetian Blinds', cat: 'Blinds' },
  { name: 'Vertical Blinds', cat: 'Blinds', img: p('vertical-blinds') },
  ...
  { name: 'Electrical Installation & Wiring', cat: 'Electricals', badge: 'Fix & supply', img: p('electrical-installation') },
  { name: 'Twin & Earth Cable — 1.5 / 2.5 / 4 / 6mm', cat: 'Electricals', img: p('twin-earth-cable') },
  { name: 'Surfix Cable', cat: 'Electricals', img: p('surfix-cable') },
  { name: 'Flexible Cord — 2 & 3 Core', cat: 'Electricals', img: p('flexible-cord') },
  ...
  { name: 'Earth Leakage Units', cat: 'Electricals', img: p('earth-leakage') },
  { name: 'Single & Double 13A Wall Sockets', cat: 'Electricals', img: p('wall-sockets') },
  { name: 'Light Switches — 1, 2 & 3 Gang', cat: 'Electricals', img: p('light-switches') },
  { name: 'Dimmer & Isolator Switches', cat: 'Electricals', img: p('dimmer-switches') },
  ...
  { name: 'Extension Cords & Multiplugs', cat: 'Electricals', img: p('extension-cords') },
  { name: 'Plug Tops & Adaptors', cat: 'Electricals', img: p('plug-tops') },
  { name: 'Ceiling & Extractor Fans', cat: 'Electricals', img: p('ceiling-fans') },
  { name: 'Doorbells & Chimes', cat: 'Electricals' },
  { name: 'Earth Rods & Clamps', cat: 'Electricals' },
  { name: 'Insulation Tape', cat: 'Electricals', img: p('insulation-tape') },
  { name: 'Meter Boxes & Enclosures', cat: 'Electricals' },

  // ---------- GENERAL HARDWARE — fix & supply (photos to follow) ----------
  { name: 'Claw Hammers', cat: 'General Hardware', img: p('claw-hammers') },
  { name: 'Screwdriver Sets', cat: 'General Hardware', img: p('screwdriver-sets') },
  { name: 'Pliers Sets', cat: 'General Hardware', img: p('pliers-sets') },
  { name: 'Adjustable Spanners', cat: 'General Hardware', img: p('adjustable-spanners') },
  { name: 'Socket & Spanner Sets', cat: 'General Hardware', img: p('socket-sets') },
  { name: 'Hacksaws & Blades', cat: 'General Hardware', img: p('hacksaws') },
  { name: 'Hand Saws', cat: 'General Hardware' },
  { name: 'Tape Measures', cat: 'General Hardware', img: p('tape-measures') },
  { name: 'Spirit Levels', cat: 'General Hardware', img: p('spirit-levels') },
  { name: 'Utility Knives', cat: 'General Hardware', img: p('utility-knives') },
  { name: 'Wheelbarrows', cat: 'General Hardware', img: p('wheelbarrows') },
  { name: 'Shovels & Spades', cat: 'General Hardware' },
  { name: 'Picks & Mattocks', cat: 'General Hardware', img: p('picks-mattocks') },
  { name: 'Garden Rakes & Forks', cat: 'General Hardware' },
  { name: "Builder's Trowels", cat: 'General Hardware', img: p('trowels') },
  { name: 'Paint Brushes & Rollers', cat: 'General Hardware', img: p('paint-brushes') },
  { name: 'Paint Trays & Buckets', cat: 'General Hardware' },
  { name: 'Mortice & Cylinder Door Locks', cat: 'General Hardware', img: p('door-locks') },
  { name: 'Padlocks', cat: 'General Hardware', img: p('padlocks') },
  { name: 'Door Handles & Levers', cat: 'General Hardware', img: p('door-handles') },
  { name: 'Cabinet & Cupboard Handles', cat: 'General Hardware' },
  { name: 'Hinges — Butt, Tee & Piano', cat: 'General Hardware' },
  { name: 'Door Closers', cat: 'General Hardware', img: p('door-closers') },
  { name: 'Assorted Nails', cat: 'General Hardware', img: p('nails') },
  { name: 'Wood & Chipboard Screws', cat: 'General Hardware', img: p('wood-screws') },
  { name: 'Self-Tapping Screws', cat: 'General Hardware', img: p('self-tapping-screws') },
  { name: 'Bolts, Nuts & Washers', cat: 'General Hardware', img: p('bolts-nuts') },
  { name: 'Wall Plugs & Anchors', cat: 'General Hardware' },
  { name: 'Silicone Sealant & Guns', cat: 'General Hardware', img: p('silicone-sealant') },
  { name: 'Wood Glue & Adhesives', cat: 'General Hardware', img: p('wood-glue') },
  { name: 'Masking, Duct & PVC Tape', cat: 'General Hardware', img: p('tape') },
  { name: 'Padbolts & Latches', cat: 'General Hardware' },
  { name: 'Chains & Wire Rope', cat: 'General Hardware' },
  { name: 'Step Ladders', cat: 'General Hardware', img: p('step-ladders') },
